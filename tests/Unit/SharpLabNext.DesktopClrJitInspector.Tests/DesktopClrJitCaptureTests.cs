...
public sealed class DesktopClrJitCaptureTests
{
    ...
    public void CodecRoundTripsBoundedCapture()
    {
        var document = new DesktopClrJitCaptureDocument(
            ...
            new List<DesktopClrJitCaptureMethod>
            {
                new(0x06000001, "Probe.Program.Add", 0x00007ff700001000, [0x48, 0x03, 0xc1, 0xc3])
            });
    ...
    public void CodecRejectsDuplicateMethodToken()
    {
        var document = new DesktopClrJitCaptureDocument(
            ...
            new List<DesktopClrJitCaptureMethod>
            {
                new(0x06000001, "Probe.Program.First", 0x1000, [0xc3]),
                new(0x06000001, "Probe.Program.Second", 0x2000, [0xc3])
            });
