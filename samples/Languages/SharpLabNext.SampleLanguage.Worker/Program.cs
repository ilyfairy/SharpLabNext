...
var identity = new ServiceIdentity(manifest.WorkerId, ServiceKind.ToolchainWorker, builder.Configuration["MINILANG_RELEASE_ID"] ?? "development", ProtocolVersion.WorkerV1, manifest.Capabilities, "ready");
