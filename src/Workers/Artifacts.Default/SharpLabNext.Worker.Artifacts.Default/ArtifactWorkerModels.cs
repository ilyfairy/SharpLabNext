...
internal sealed record ArtifactJobExecution(
    OperationResult Result,
    ProducedContent? Content = null,
    ProducedArtifact? Artifact = null);
...
{
    Task<ArtifactJobExecution> TransformAsync(
        TransformArtifactRequest request,
        string operationId,
        CancellationToken cancellationToken);

    Task<ArtifactJobExecution> RenderAsync(
        RenderArtifactRequest request,
        string operationId,
        CancellationToken cancellationToken);

    Task<ArtifactJobExecution> VerifyAsync(
...
{
    public ArtifactWorkerException(string message)
        : base(message)
    {
    }

    public ArtifactWorkerException(string message, Exception innerException)
...
internal sealed class ArtifactStoreUnavailableException(string message, Exception innerException)
    : ArtifactWorkerException(message, innerException);
