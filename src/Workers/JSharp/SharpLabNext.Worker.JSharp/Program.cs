...
builder.Services.AddSharpLabNextLanguageWorker<JSharpBuildService>(identity, manifest, LanguageWorkerHostMetadata.Create(identity.Id, settings.Identity.WorkerImageId, [settings.ReferenceSet.CreateAttestation()]));
