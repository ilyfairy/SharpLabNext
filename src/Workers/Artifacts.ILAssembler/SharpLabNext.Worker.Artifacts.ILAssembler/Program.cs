...
builder.Services.AddSingleton<IArtifactTransformHandler>(services => services.GetRequiredService<IlAssemblerArtifactHandler>());
builder.Services.AddSingleton<IArtifactRenderHandler>(services => services.GetRequiredService<IlAssemblerArtifactHandler>());
