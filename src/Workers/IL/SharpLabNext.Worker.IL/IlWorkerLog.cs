...
internal static partial class IlWorkerLog
{
    ...
    public static partial void TemporaryDirectoryCleanupFailed(ILogger logger, Exception exception, string path);

    [LoggerMessage(2, LogLevel.Warning, "The isolated IL assembler is unavailable for request {RequestId}.")]
    public static partial void AssemblerUnavailable(ILogger logger, Exception exception, string requestId);
