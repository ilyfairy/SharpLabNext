...
public sealed record IlWorkerBuildHttpResponse(
    string RequestId,
    OperationResult Result,
    IlDevelopmentArtifactEnvelope? DevelopmentArtifact);
...
public sealed record IlDevelopmentArtifactEnvelope(
    ...
    IReadOnlyList<ArtifactFileDescriptor> Files)
{
    public static IlDevelopmentArtifactEnvelope FromArtifact(
        IlCompiledArtifact artifact,
        IlDevelopmentArtifactEnvelopeOptions options)
    {
        ...
        return new IlDevelopmentArtifactEnvelope(
...
public sealed class IlAssemblerUnavailableException(string message, Exception? innerException = null)
    : IlWorkerException(message, innerException ?? new InvalidOperationException(message));
...
public sealed class IlBuildDeadlineExceededException(string message, CancellationToken cancellationToken)
