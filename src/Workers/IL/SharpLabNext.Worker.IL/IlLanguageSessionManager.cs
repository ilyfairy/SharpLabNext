...
public sealed class IlLanguageSessionManager(
    IlReferenceSetProvider referenceSets,
    IlLanguageService languageService,
    IlWorkerSettings settings) : IDisposable
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var validated = IlWorkspaceValidator.Validate(
            new BuildRequest(
                request.RequestId,
                request.RequestId,
        ...
        var metadataCatalog = await referenceSets.GetCatalogAsync(
            request.ReferenceSetId,
        ...
        try
        {
            ...
            var session = new IlLanguageSession(
                sessionId,
                validated,
                languageService,
                metadataCatalog,
            ...
            return new LanguageSession(
                ...
                $"Mobius.ILasm/{settings.Identity.CompilerVersion}+EleCho.ILSense/{IlSenseVersion}",
