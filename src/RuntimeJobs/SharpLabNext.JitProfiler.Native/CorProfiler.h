...
public:
    ...
    void WaitForCallbacks()
    {
        ...
        drained.wait(lock, [this] { return activeCallbacks == 0; });
    }
};
...
public:
    explicit CallbackLifetimeGuard(CallbackLifetimeGate& gate)
        : gate(gate.TryEnter() ? &gate : nullptr)
    {
    }
...
private:
    ...
    ICorProfilerInfo12* eventPipeProfilerInfo;
    EVENTPIPE_SESSION eventPipeSession;
    CallbackLifetimeGate profilerInfoCallbacks;
public:
    CorProfiler();
    virtual ~CorProfiler();
