...
function sameJson(left, right) { return serializeRuntimePromotionPlan(left).equals(serializeRuntimePromotionPlan(right)); }
...
if (process.argv[1] !== undefined &&
  ...
  for (let index = 2; index < process.argv.length; index += 1) {
    ...
    if (option !== '--repository-root' && option !== '--matrix') {
      console.error(
        'Usage: node eng/release/runtime-promotion-receipt-validation.mjs ' +
