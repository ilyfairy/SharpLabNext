...
const evidenceRoles = new Set(['helper', 'control-host', 'runtime-host', 'support-assembly', 'jit-library', 'profiler'])
...
function isBoundedByteCount(value) { return Number.isSafeInteger(value) && value >= 0 && value <= 16777216; }
