...
export const runtimeMatrixDeploymentBridgeUsage = `Usage:
  node eng/smoke/runtime-matrix-deployment-bridge.mjs
...
export function buildRuntimeMatrixDeploymentBridge(options = {}) {
  ...
  const bindings = formalRuntimeCandidateProfileIds(matrix).map(profileId => bindProfile(rows.get(profileId), profileDirectory, matrixBindings.get(profileId)))
