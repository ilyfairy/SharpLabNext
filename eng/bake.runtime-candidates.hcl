...
variable "RUNTIME_MATRIX_HISTORICAL_FRAMEWORK_INPUT" {
  default = ""
}
...
variable "WINE_CORECLR_LOCAL_OPERATOR_IMAGE" {
  default = ""
}

variable "WINE_CORECLR_LOCAL_OPERATOR_TAG" {
  default = ""
}
...
target "runtime-wine-dotnet-matrix-candidate" {
  ...
  args = {
    ...
    ALLOW_LOCAL_IMAGE_ID = WINE_CORECLR_LOCAL_OPERATOR_IMAGE
    ALLOW_LOCAL_IMAGE_TAG = WINE_CORECLR_LOCAL_OPERATOR_IMAGE
    CONTROL_IMAGE = RUNTIME_MATRIX_CONTROL_IMAGE
    CONTROL_TFM = required(WINE_CONTROL_TFM)
  }
  labels = merge({
