...
export const runtimeFrameworkSupervisorSmokeUsage = `Usage:
  node eng/runtime-framework-supervisor-smoke.mjs --profile wine-netfx48-linux-x64 --prepare-only [--overlay PATH]
  node eng/runtime-framework-supervisor-smoke.mjs --profile wine-netfx48-linux-x64 --supervisor URL --roslyn-worker URL --token-file PATH [--results PATH] [--overlay PATH]`
